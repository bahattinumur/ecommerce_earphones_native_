...
export default function ProductInfo() {
  ...
  //* Bastığımız ürünün ID'sini useRoute içerisindeki params'dan aldık.
  ...
  const getDataFromDB = () => {
    ...
    //   }
    // }
    //* ID'sini bildiğimiz ürünü find metodu kullanarak product state'ine aktardık.
  ...
  const addToCart = async id => {
    ...
    if (itemArray) {
      ...
      try {
        await AsyncStorage.setItem('cartItems', JSON.stringify(array));
        // AsyncStorage veriyi ekledikten sonra homescreen'e yönlendir.
        navigation.navigate('Home');
      } catch (error) {
        console.log(error);
        return error;
